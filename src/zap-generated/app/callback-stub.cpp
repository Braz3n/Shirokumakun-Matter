...
void __attribute__((weak))
emberAfCarbonDioxideConcentrationMeasurementClusterShutdownCallback(EndpointId endpoint) {
    // To prevent warning
    (void)endpoint;
}
...
void __attribute__((weak))
emberAfRelativeHumidityMeasurementClusterShutdownCallback(EndpointId endpoint) {
    // To prevent warning
    (void)endpoint;
}
