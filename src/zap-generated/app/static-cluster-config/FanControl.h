...
// from /workspace/src/ac_controller.matter
#pragma once
...
inline constexpr AttributeId kEndpoint1EnabledAttributes[] = {
    Attributes::AirflowDirection::Id, Attributes::ClusterRevision::Id,
    Attributes::FanMode::Id,          Attributes::FanModeSequence::Id,
    Attributes::FeatureMap::Id,       Attributes::PercentCurrent::Id,
    Attributes::PercentSetting::Id,   Attributes::RockSetting::Id,
    Attributes::RockSupport::Id,      Attributes::SpeedCurrent::Id,
    Attributes::SpeedMax::Id,         Attributes::SpeedSetting::Id,
...
inline constexpr std::array<
    Clusters::StaticApplicationConfig::ClusterConfiguration<FeatureBitmapType>, 1>
    kFixedClusterConfig = {{
        {
            .endpointNumber = 1,
            .featureMap =
