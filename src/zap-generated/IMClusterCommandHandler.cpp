    ...
    bool       wasHandled = false;
    {
        ...
        case Commands::Step::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled =
                    emberAfFanControlClusterStepCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
...
Protocols::InteractionModel::Status DispatchServerCommand(CommandHandler            *apCommandObj,
    ...
    bool       wasHandled = false;
    {
        ...
        case Commands::AddGroup::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled =
                    emberAfGroupsClusterAddGroupCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::ViewGroup::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled =
                    emberAfGroupsClusterViewGroupCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        ...
        case Commands::RemoveGroup::Id: {
            ...
            TLVError = commandData.Decode(aDataTlv, apCommandObj->GetAccessingFabricIndex());
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled = emberAfGroupsClusterRemoveGroupCallback(apCommandObj, aCommandPath,
                                                                     commandData);
            }
            break;
        }
        case Commands::RemoveAllGroups::Id: {
            ...
            TLVError = commandData.Decode(aDataTlv, apCommandObj->GetAccessingFabricIndex());
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled = emberAfGroupsClusterRemoveAllGroupsCallback(apCommandObj, aCommandPath,
                                                                         commandData);
            }
            break;
        }
...
Protocols::InteractionModel::Status DispatchServerCommand(CommandHandler            *apCommandObj,
    ...
    bool       wasHandled = false;
    {
        ...
        case Commands::Off::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled =
                    emberAfOnOffClusterOffCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        case Commands::On::Id: {
        ...
        case Commands::Toggle::Id: {
            ...
            if (TLVError == CHIP_NO_ERROR) {
                wasHandled =
                    emberAfOnOffClusterToggleCallback(apCommandObj, aCommandPath, commandData);
            }
            break;
        }
        default: {
