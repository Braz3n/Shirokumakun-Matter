...
#define GENERATED_ATTRIBUTES                                                                       \
    {                                                                                              \
        ...
        {ZAP_SIMPLE_DEFAULT(0x03), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                              \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                                           \
        {ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                     \
         ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                                    \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                                  \
        ...
        {ZAP_MIN_MAX_DEFAULTS_INDEX(11), 0x00000002, 1, ZAP_TYPE(PERCENT),                         \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                              \
        ...
        {ZAP_MIN_MAX_DEFAULTS_INDEX(12), 0x00000005, 1, ZAP_TYPE(INT8U),                           \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                              \
             ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* SpeedSetting */      \
        {ZAP_SIMPLE_DEFAULT(0x00), 0x00000006, 1, ZAP_TYPE(INT8U),                                 \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* SpeedCurrent */                                         \
        {ZAP_SIMPLE_DEFAULT(0x03), 0x00000007, 1, ZAP_TYPE(BITMAP8),                               \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* RockSupport */                                          \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(13), 0x00000008, 1, ZAP_TYPE(BITMAP8),                         \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                              \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* RockSetting */                                      \
        {ZAP_SIMPLE_DEFAULT(0x03), 0x00000009, 1, ZAP_TYPE(BITMAP8),                               \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* WindSupport */                                          \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(14), 0x0000000A, 1, ZAP_TYPE(BITMAP8),                         \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                              \
             ZAP_ATTRIBUTE_MASK(READABLE)}, /* WindSetting */                                      \
        {ZAP_MIN_MAX_DEFAULTS_INDEX(15), 0x0000000B, 1, ZAP_TYPE(ENUM8),                           \
         ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) |                              \
        ...
        {ZAP_SIMPLE_DEFAULT(1), 0x00000003, 2, ZAP_TYPE(INT16U),                                   \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* Tolerance */                                            \
        {ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                                 \
         ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                   \
    {                                                                                              \
        ...
        {ZAP_CLUSTER_INDEX(12), 9, 69},                                                            \
        {ZAP_CLUSTER_INDEX(21), 3, 14},                                                            \
        {ZAP_CLUSTER_INDEX(24), 4, 4},                                                             \
    }
...
#define FIXED_DEVICE_TYPES {{0x00000016, 3}, {0x00000301, 4}, {0x00000307, 1}, {0x0000002C, 1}}
